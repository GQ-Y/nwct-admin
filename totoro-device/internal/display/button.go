...
// Render 渲染按钮
func (b *Button) Render(g interface{}) error {
	gfx := g.(*Graphics)
	...
	// 绘制文本（居中）
	textWidth := gfx.MeasureText(b.Text, 16, FontWeightMedium)
	...
	gfx.DrawTextTTF(b.Text, textX, textY, textColor, 16, FontWeightMedium)
